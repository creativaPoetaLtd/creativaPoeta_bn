...
exports.triggerFrontendBuild = void 0;
const hookUrl = () => { var _a; return ((_a = process.env.FRONTEND_BUILD_HOOK_URL) === null || _a === void 0 ? void 0 : _a.trim()) || ""; };
const triggerFrontendBuild = async (reason) => {
    ...
    const timeout = setTimeout(() => controller.abort(), Math.max(3000, Number(process.env.FRONTEND_BUILD_HOOK_TIMEOUT_MS) || 10000));
    try {
        ...
        console.error("Frontend build hook unavailable:", error instanceof Error ? error.message : "unknown error");
        return {
            status: "failed",
...
exports.triggerFrontendBuild = triggerFrontendBuild;
